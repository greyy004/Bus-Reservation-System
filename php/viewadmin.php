    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <div class="grid">
                ...
                $query = "SELECT user_id, fullname, username, email FROM user WHERE usertype='admin'";
                ...
                if ($result) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                           ...
                           <br>
                                <label for="user_id" style='text-align:center';>Admin Id: <?php echo htmlspecialchars($row['user_id']); ?></label>
                                <br><br>
